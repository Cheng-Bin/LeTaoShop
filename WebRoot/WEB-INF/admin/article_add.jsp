			...
			<div id="right" >
				<div class="content" style="overflow:scroll">
					<div class="rtbd">
						<div class="jyjl">
							<h2>
								<img src="${context_path}/images/ibg1.jpg" />添加新闻
							</h2>
						</div>
						<div class="clear"></div>
						<table class="tblist" width="100%" border="0" cellspacing="0" cellpadding="0" >
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="articleTitle" type="text" id="articleTitle" size="30" value="" />
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="articleLabel" id="articleLabel" size="30" value=""></s:textfield>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="articleAddress" id="articleAddress" size="30" value="" />
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:select list="map" name="category.categoryId"></s:select>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textarea id="articleStatement" name="articleStatement"></s:textarea>
								</td>
							</tr>
							<tr>
								...
								<td style="padding: 20px 100px 20px 0px;">
									<textarea id="articleContent" name="articleContent" cols="50" rows="100"></textarea>
								</td>
							</tr>
							<tr>
