...
<script type="text/javascript">
	...
	function checkForm(form) {
		...
		return loadData(dom, "${context_path}/articleType/articleType_already", params, form, "新闻类别");
	}
</script>
			...
			<div id="right">
				<div class="content">
					<div class="rtbd">
						<div class="jyjl">
							<h2>
								<img src="${context_path}/images/ibg1.jpg" />添加文章分类
							</h2>
						</div>
						<div class="clear"></div>
						<table class="tblist" width="100%" border="0" cellspacing="0"
							...
							<tr>
								...
								<td>
									<s:textfield name="categoryName" id="categoryName" size="30" value="" />
								</td>
							</tr>
							<tr>
								<td align="right">类别介绍：</td>
								<td style="padding: 20px 100px 20px 0px;">
									<textarea id="categoryIntro" name="categoryIntro" cols="50" rows="50"></textarea>
								</td>
							</tr>
							<tr>
