		...
		<div id="right">
			<div class="content" style="overflow:scroll">
				<div class="rtbd">
					<div class="jyjl">
						<h2>
							<img src="${context_path}/images/ibg1.jpg" />产品修改
						</h2>
					</div>
					<div class="clear"></div>
					<s:form action="save" namespace="/product" method="post" enctype="multipart/form-data">
						<table class="tblist" width="100%" border="0" cellspacing="0"
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="name" id="name" size="30" value="%{product.name}"></s:textfield>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="tag" id="tag" size="30" value="%{product.tag}" ></s:textfield>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:file name="picFile" id="picFile"></s:file> 若不需要更新，请不要添加图片.
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:select list="categoryMap" name="category.categoryId" value="%{product.category.categoryId}"></s:select>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="marketPrice" id="marketPrice" size="30" value="%{product.marketPrice}"></s:textfield>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="sellPrice" id="sellPrice" size="30" value="%{product.sellPrice}" />
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:textfield name="count" id="count" size="30" value="%{product.count}" />
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:select name="sexRequest" list="#{'0':'男','1':'女','2':'不限'}" value="%{product.sexRequest}"></s:select>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:radio name="commend" list="#{'true':'推荐', 'false':'不推荐'}" value="%{product.commend}"></s:radio>
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:radio name="sale" list="#{'true':'是', 'false':'否'}" value="%{product.sale}"></s:radio>	
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:radio name="promotion" list="#{'true':'是', 'false':'否'}" value="%{product.promotion}"></s:radio>	
								</td>
							</tr>
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<s:radio name="limit" list="#{'true':'是', 'false':'否'}" value="%{product.limit}"></s:radio>		
								</td>
							</tr>
							<tr>
								...
								<td style="padding: 20px 100px 20px 0px;">
									<textarea name="description" id="description"><s:property value="product.description" /></textarea>
								</td>
							</tr>
							<tr>
								<th class="edit" colspan="3">
									<s:hidden name="clickCount" id="clickCount" value="%{product.clickCount}" />
									<s:hidden name="id" id="id" value="%{product.id}"></s:hidden>
									<s:hidden name="uploadFile.id" value="%{product.uploadFile.id}"></s:hidden>
